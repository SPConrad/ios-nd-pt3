...
class StoryNodeViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        numberOfChoices = storyNode.promptCount()
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let newStoryNodeController = storyboard?.instantiateViewController(withIdentifier: "StoryNodeViewController") as! StoryNodeViewController
        
        newStoryNodeController.storyNode = storyNode.storyNodeForIndex(index: (indexPath as NSIndexPath).row)
        
        self.navigationController!.pushViewController(newStoryNodeController, animated: true)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel!.text = storyNode.promptForIndex(row)
